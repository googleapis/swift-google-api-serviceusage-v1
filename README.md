# Google Cloud Client Libraries for Swift - Service Usage API
...
Add `swift-google-api-serviceusage-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-api-serviceusage-v1.git --from 0.1.0-preview
```

Then add `GoogleApiServiceUsageV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleApiServiceUsageV1 <target-name> --package swift-google-api-serviceusage-v1
```
